...
public class AncientDebreetleRenderer extends MobRenderer<AncientDebreetleEntity, JewelBeetleModel<AncientDebreetleEntity>> {
    ...
    private static final ResourceLocation MAIN_TEXTURE = InfestedSwarmsAndSpiders.prefix("textures/entity/debris_beetle.png");
    private static final ResourceLocation EMISSIVE_TEXTURE = InfestedSwarmsAndSpiders.prefix("textures/entity/debris_beetle_glow.png");

    public AncientDebreetleRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new JewelBeetleModel<>(pContext.bakeLayer(ModEntityClientEvents.ANCIENT_DEBREETLE_LAYER)), 0.3f);
