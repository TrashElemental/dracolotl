...
public class ChorusBeetleRenderer extends MobRenderer<ChorusBeetleEntity, JewelBeetleModel<ChorusBeetleEntity>> {
    ...
    private static final ResourceLocation MAIN_TEXTURE = InfestedSwarmsAndSpiders.prefix("textures/entity/chorus_beetle.png");
    private static final ResourceLocation EMISSIVE_TEXTURE = InfestedSwarmsAndSpiders.prefix("textures/entity/chorus_beetle_glow.png");

    public ChorusBeetleRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new JewelBeetleModel<>(pContext.bakeLayer(ModEntityClientEvents.CHORUS_BEETLE_LAYER)), 0.3f);
